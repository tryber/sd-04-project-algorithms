...
def is_anagram(first_string, second_string):
    ...
    for index in range(len(first_string)):
        first_string_sorted.append(first_string[index])

    second_string_sorted = []
    for index in range(len(second_string)):
        second_string_sorted.append(second_string[index])

    return merge_sort(first_string_sorted) == merge_sort(second_string_sorted)
